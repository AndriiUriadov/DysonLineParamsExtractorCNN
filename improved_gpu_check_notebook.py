# =============================================================================
# ПЕРЕВІРКА СИСТЕМНИХ РЕСУРСІВ (GPU та RAM) - ВЕРСІЯ ДЛЯ NOTEBOOK
# =============================================================================
...
def check_gpu_availability():
    ...
    try:
        ...
        gpu_info['error_message'] = 'Таймаут при виконанні nvidia-smi (15 сек)'
    except FileNotFoundError:
        gpu_info['error_message'] = 'nvidia-smi не знайдено (драйвери NVIDIA не встановлені)'
    except Exception as e:
        gpu_info['error_message'] = f'Невідома помилка: {str(e)}'
    
    return gpu_info

def check_ram_availability():
    """
    Перевіряє доступну оперативну пам'ять
    Returns:
...
# =============================================================================
# ВИКОНАННЯ ПЕРЕВІРОК (ЗАМІНА ОРИГІНАЛЬНОГО КОДУ)
# =============================================================================

print("🔍 ПЕРЕВІРКА СИСТЕМНИХ РЕСУРСІВ")
print("=" * 50)
